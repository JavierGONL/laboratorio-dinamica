...
\begin{enumerate}
    ...
    \item Calcular la fuerza de excitación $P_m$ usando la ecuación\eqref{eq:F_exc}:
    \[
        P_m = M_h\, r\, \omega_f^2
    \]
    con
    \[
        M_h = 0.05616\ \text{kg}, \qquad r = 0.045\ \text{m}
    \]
...
\begin{table}[htbp]
    ...
    \begin{tabular}{l S[table-format=1.2] S[table-format=2.4] S[table-format=1.4] S[table-format=1.4] S[table-format=1.4] S[table-format=1.4] S[table-format=1.4] S[table-format=1.4] S[table-format=-3.4]}
        ...
        \midrule
        Abierta & 4.20 & 26.3894 & 1.7599 & 0.3257 & 7.2222 & 1.7895 & 0.6642 & 0.3746 & -132.0263 \\
        Abierta & 4.30 & 27.0177 & 1.8447 & 0.6861 & 7.2222 & 1.8603 & 0.6800 & 0.3987 & -261.3675 \\
        Abierta & 4.45 & 27.9602 & 1.9757 & 0.5992 & 7.2222 & 1.9813 & 0.7038 & 0.4394 & -197.9133 \\
        Cerrada & 4.20 & 26.3894 & 1.7599 & 0.3797 & 7.2222 & 1.7895 & 0.6642 & 0.3559 & -260.7307 \\
        Cerrada & 4.30 & 27.0177 & 1.8447 & 0.3697 & 7.2222 & 1.8603 & 0.6800 & 0.3878 &  -4.0398 \\
        Cerrada & 4.45 & 27.9602 & 1.9757 & 0.2707 & 7.2222 & 1.9813 & 0.7038 & 0.4175 &   0.2567 \\
        \bottomrule
    \end{tabular}
\end{table}
\vspace{-4pt}
...
cruzando $90^\circ$ cerca de la resonancia. Los valores experimentales
reportados, una vez reducidos al intervalo $[0^\circ,180^\circ]$, siguen esta
tendencia: por ejemplo, para $r=0.680$ con amortiguador \textit{cerrado}
obtenemos $\varphi_{\text{exp}}\approx4^\circ$, mientras que con amortiguador
\textit{abierto} a $r=0.664$ se obtiene \mbox{$\varphi_{\text{exp}}\approx132^\circ$},
coherente con una mayor proximidad relativa a la resonancia efectiva.
...
\[\zeta_{\text{abierta}}=0.0028,\qquad \zeta_{\text{cerrada}}=0.0260.\]
